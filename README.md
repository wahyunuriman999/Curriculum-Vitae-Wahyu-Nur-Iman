...
<table>
  <tr>
    <td width="50%">
      ...
      <p>Mengintegrasikan AI lokal menggunakan API Key & Ollama untuk mempercepat analisis data dan otomatisasi respon, dikombinasikan dengan teknik Vibe Coding.</p>
    </td>
    <td width="50%">
      <h3>🔍 Fuzzy Matching Toolkit</h3>
      <p>Tool cerdas (Fuzzy Lookup) untuk mendeteksi tingkat kemiripan data teks (Similarity Matching Nama) secara otomatis, mengurangi error administratif.</p>
    </td>
  </tr>
  <tr>
    <td width="50%">
      <h3>⚡ Google Apps Script Automation</h3>
      <p>Sistem otomatisasi alur kerja berbasis cloud di ekosistem Google Workspace untuk pelaporan harian, rekapitulasi, dan manajemen data.</p>
    </td>
    <td width="50%">
      <h3>🌐 WEB Cek Rekening</h3>
      <p>Pembuatan antarmuka web khusus untuk memverifikasi dan mengecek validitas nomor rekening secara real-time untuk kebutuhan payroll.</p>
    </td>
  </tr>
</table>
...
<div align="center">
  ...
  <img src="https://img.shields.io/badge/VBA-008000?style=flat-square&logo=microsoft-excel&logoColor=white" alt="VBA">
